  ...
  public void onResume() {
    ...
    if (camera == null) {
      try {
        ...
        if (newcamID==CameraInfo.CAMERA_FACING_FRONT || newcamID==CameraInfo.CAMERA_FACING_BACK) {
          camera=Camera.open(newcamID);
...
switch (newcamID){
  case (CameraInfo.CAMERA_FACING_BACK): newcamID=CameraInfo.CAMERA_FACING_FRONT;
    break;
  case (CameraInfo.CAMERA_FACING_FRONT):newcamID=CameraInfo.CAMERA_FACING_BACK;
    break;
}
    onResume();
